...
class DefenderCyborgEnv(Env):
    def __init__(self):
        ...
        # Zero-optimal parameters
        self.patch_reward = 0
        self.restore_per_service_reward = 0
        self.monitor_reward = 0
        self.monitor_enable_bonus = 0
        self.scan_reward = 0
        self.unnecessary_action_penalty = -3  # Increased
        self.scan_unnecessary_penalty = -4  # Increased for exploit #8
        self.base_persistent_breach_penalty = -3  # Increased
        self.inaction_penalty = -3  # Increased for #4
        self.detection_ignored_penalty = -5
        self.lingering_detection_penalty = -5  # Increased for #1
        ...
        self.observation_noise_prob = 0.05  # Reduced for detection bit (mitigate #6)
        self.detection_required_fix_attempts = 0
        self.fix_without_scan_penalty = -3  # New for #9
        ...
        self.last_fix_step = -1  # For gating scan after fix
