...
from mini_cyborg_v3 import DefenderCyborgEnv
...
logdir = "logs/train_PPO_v3_5M_seed_" + str(seed) + "_" + time.strftime("%Y%m%d_%H%M%S")
...
model.learn(total_timesteps=5_000_000, callback=info_callback)
